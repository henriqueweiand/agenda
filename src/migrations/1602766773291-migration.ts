...
export class migration1602766773291 implements MigrationInterface {
    name = 'migration1602766773291'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "scheduling" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" text NOT NULL, "start" TIMESTAMP NOT NULL, "end" TIMESTAMP NOT NULL, "establishmentId" uuid NOT NULL, "patientId" uuid NOT NULL, "professionalId" uuid NOT NULL, "handbookId" uuid, "clerkId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT LOCALTIMESTAMP, "updatedAt" TIMESTAMP NOT NULL DEFAULT LOCALTIMESTAMP, "deletedAt" TIMESTAMP DEFAULT null, CONSTRAINT "PK_a19510fdc2c3f1c9daff8b6e395" PRIMARY KEY ("id"))`, undefined);
